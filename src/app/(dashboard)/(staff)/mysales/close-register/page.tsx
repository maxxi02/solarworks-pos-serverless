...
export default function CloseRegisterPage() {
  ...
  const handleCloseRegister = () => {
    ...
    // Prepare complete summary data with actual cash
  ...
  const handleZReportClose = () => {
    ...
    // Use replace instead of push para di na makabalik sa closing page
  ...
  const handleConfirmClose = () => {
    ...
    // Use replace para sure na di na makabalik
    router.replace('/dashboard/reports');
  };
...
<div style="text-align:center;font-weight:bold;font-size:${fsL};margin-top:4px">*** END OF Z-REPORT ***</div>
  ...
  const StatusCard = () => {
    ...
    const messages = {
      ...
      balanced: {
        title: '✓ BALANCED ✓',
        desc: `Expected: ${fmtP(summary.expectedCash)} | Counted: ${fmtP(counted)} | Diff: ${fmtP(difference)}`,
        color: 'green'
      },
      short: {
        ...
        <div className="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg p-6 mt-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {actualCash !== '' && (
                <div className={`mt-2 text-sm ${isBalanced ? 'text-green-600' : difference < 0 ? 'text-red-600' : 'text-blue-600'}`}>
