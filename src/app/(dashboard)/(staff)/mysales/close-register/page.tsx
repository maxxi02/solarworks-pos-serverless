  ...
  const loadData = async () => {
    ...
    try {
      ...
      setSummaryData({
        ...
        tenders: { cash: cashSalesDirect, gcash: gcashSalesDirect, split: splitPayments.reduce((s: number, p: Payment) => s + p.total, 0), credit_card: 0, pay_later: 0, online: 0, invoice: 0, e_wallet: 0, pay_in: 0 },
