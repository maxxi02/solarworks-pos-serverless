...
import { MessageSquare, Clock, Utensils, User, Car, ChevronRight, CheckCheck } from "lucide-react";
        ...
        <div className="rounded-lg border bg-background border-border hover:border-primary/30 hover:shadow-sm transition-all p-3 space-y-2">
            ...
            <div className="flex items-center justify-between pt-2 border-t border-border">
                ...
                <div className="flex items-center gap-2">
                    <span className="font-bold text-foreground text-xs">₱{order.total?.toFixed(0)}</span>
