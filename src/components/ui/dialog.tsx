    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "max-h-[90dvh] overflow-hidden rounded-lg border shadow-lg duration-200 outline-none",
          className
        )}
        {...props}
      >
...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-col gap-2 p-6 pb-2 pr-12 text-center sm:text-left shrink-0", className)}
      {...props}
    />
  )
}
...
function DialogBody({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex-1 overflow-y-auto overscroll-contain px-6 py-4 min-h-0", className)}
      {...props}
    />
  )
}
